...
export default function MenuButtonsComponent() {
    ...
    let settingsSvg = (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Layer 1</title><path fill="#b7b7b7" d="M9.26 1.12C9.39.47 9.97 0 10.64 0h2.63c.67 0 1.24.47 1.38 1.12l.64 3.08c.62.26 1.2.6 1.73 1L20 4.21c.63-.21 1.33.05 1.66.63l1.31 2.28c.33.58.22 1.31-.29 1.75l-2.34 2.08a8.3 8.3 0 0 1 0 2l2.35 2.09c.5.44.62 1.18.29 1.75l-1.31 2.28c-.33.58-1.03.84-1.66.63l-2.98-.99c-.53.4-1.11.73-1.73 1l-.63 3.07c-.14.66-.71 1.12-1.38 1.12h-2.63c-.67 0-1.24-.47-1.38-1.12l-.63-3.07c-.62-.26-1.2-.6-1.73-1l-2.99.99c-.63.21-1.33-.05-1.66-.63L.96 16.79c-.33-.58-.22-1.31.29-1.75l2.35-2.09a8.3 8.3 0 0 1 0-2L1.25 8.86C.75 8.42.63 7.68.96 7.11l1.31-2.28c.33-.58 1.03-.84 1.66-.63l2.98.99c.53-.4 1.11-.73 1.73-1l.64-3.07zm2.69 14.36a3.517 3.517 0 0 0 3.5-3.53 3.517 3.517 0 0 0-3.53-3.5 3.517 3.517 0 0 0-3.5 3.53 3.517 3.517 0 0 0 3.53 3.5"/></svg>);
    return (
